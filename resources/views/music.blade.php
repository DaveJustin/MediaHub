									...
									<div class="col-md-8 col-sm-12 col-xs-12">
										...
										<div  style ="opacity: 0;">
											<form action="{{ route('music_save') }}" id="musicform" method="POST">
													...
													<input type="hidden" class="form-control" name="music_fav_genre" value="${musicdata.track.toptags.tag[0].name}">
											
													<input type="hidden" class="form-control" name="music_fav_rating" value="${musicdata.track.listeners}">
													<input type="hidden" class="form-control" name="music_fav_desc" value="${descrip}">
													...
													<input type="hidden" class="form-control" name="music_fav_year" value="${musicdata.track.wiki.published}">
													...
													<input type="hidden" class="form-control" name="music_fav_lyrics" value="${musiclyrics}">
												...
												<div class="tabs">
													...
													<div class="tab-content">
														<div id="overview" class="tab active">
															<div class="row">
																<div class="col-md-8 col-sm-12 col-xs-12">
																	<p>${musicdata.track.wiki.summary}</p>
																...
																<div class="col-md-4 col-xs-12 col-sm-12">
																	...
																	<div class="sb-it">
																		<h6>Date Released</h6>
																		<p class="tags">
																			<span class="time"><a href="#">${musicdata.track.wiki.published}</a></span>
																	...
																	<div class="sb-it">
																		<h6>Genre</h6>
																		<p class="tags">
																			<span class="time"><a href="#">${musicdata.track.toptags.tag[0].name}</a></span>
